...
class ItemsControllerTest < ActionDispatch::IntegrationTest
  ...
  # The no-JS path: the filters open natively and the noscript submit applies
  # them; the search field lives in the same form so submitting keeps filters.
  test "index works without JavaScript" do
    get items_url
