module ItemsHelper
  ...
  def generic_card_stats(d)
    # Helmets and plates are Generic but carry an armor class; show it rather
    # than the raw wiki type.
    return [ [ "CLASS", d["class"], armor_class_tone(d["class"]) ] ] if d["class"].present?
