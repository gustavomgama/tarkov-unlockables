...
- achievements: 123
- specialItems: 37 ids — 28 item ids, 9 *category* ids (compass, range finder, map, multitools...); joining this list to items silently drops the category rows
...
- wiki infobox `trader` field parses to 2536 trader/loyalty offers across 2371 items; cross-checked against canonical buy/index_offers in `99_verify.py`
